...
const Cart = () => {
  ...
  return (
    <ScrollView>
      <ImageBackground
        source={{
          uri: "https://besthqwallpapers.com/Uploads/20-8-2019/102143/thumb2-black-stylish-background-green-neon-lines-green-light-effects-abstract-black-background.jpg",
        }}
        style={
          carrito.length !== 0
            ? { marginBottom: 150, height: "100%", width: "100%" }
            : { marginBottom: 400, height: "100%", width: "100%" }
        }
      >
        <View style={styles.logoLinkdiv}>
          <View style={styles.logoLink}>
            <Link to="/">
              <Text style={{ color: "#88D317", fontSize: 20 }}>
                Ir al Inicio
              </Text>
            </Link>
            <Image
              source={logo}
              alt="logo"
              style={{ height: 115, width: 135 }}
            ></Image>
          </View>
        </View>
        <Text style={styles.textEnviosGratis}>
          {" "}
          Envio gratis y 12 cuotas sin interes desde $1.000
        </Text>
              ...
              carrito.map((item) => (
                <View key={item.name} style={styles.productos}>
                  ...
                  <View style={styles.precioCantidad}>
                    ...
                    <Icon
                      onPress={() => removeToCart(item._id, true)}
                      name="delete"
                      style={{
                        color: "#88D317",
                        cursor: "pointer",
